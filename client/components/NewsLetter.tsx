...
export default function NewsLetter() {
  ...
  return (
    ...
    >
      <div className="">
        <h1 className="text-2xl md:text-4xl text-gray-800 font-extrabold">
          Let&apos;s stay in touch
        </h1>
        <p className="text-xl md:text-3xl text-gray-600 pt-5 font-medium">
          You can join our newsletter, so that we reach out to you with
          <br /> our news and offers.
        </p>
      </div>
      <form onSubmit={handleSubmit}>
        <div className="justify-center md:flex md:items-center md:gap-4 px-10 mt-5 md:justify-center grid space-y-4 md:space-y-0">
          <input
            type="email"
            required
